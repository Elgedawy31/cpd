    ...
    <footer className="w-full bg-[#0F0F0F] text-white py-12 px-6 md:px-12 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1: Language, Description, Follow Us */}
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-2 text-sm opacity-70 leading-relaxed">
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-1 shrink-0" />{t('location1')}
              </li>
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-1 shrink-0" />{t('location2')}
              </li>
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-1 shrink-0" />{t('location3')}
              </li>
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-1 shrink-0" />{t('location4')}
              </li>
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-1 shrink-0" />{t('location5')}
              </li>
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-1 shrink-0" />{t('location6')}
              </li>
              <li className="flex items-start gap-2">
                <MapPin size={16} className="mt-1 shrink-0" />{t('location7')}
              </li>
            </ul>
          </div>
